...
class HistoricalCurrenciesRepoImpl @Inject constructor(private val historicalCurrenciesDao: HistoricalCurrenciesDao) :
    ...
    override suspend fun insertHistoryCurrency(
    ...
    override suspend fun getHistoricalCurrenciesDataByDay(day: String): Flow<List<HistoricalCurrenciesData>> {
        return historicalCurrenciesDao.getHistoricalCurrenciesDataByDay(day = day)
            .map { historicalCurrenciesList ->
